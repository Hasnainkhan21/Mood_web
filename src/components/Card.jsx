...
const Card = (props) => {
  return (
    <StyledWrapper>
      <div className="container noselect mt-2">
        <div className="canvas">
          ...
          <div id="card">
            <div className="card-content">
              ...
              <p id="prompt"><img src={hPhone} alt="" className='size-25' /></p>
              <div className="title">{props.title} <br />songs</div>
              ...
              <button className="bg-blue-400 cursor-pointer hover:bg-blue-700 active:w-20 active:text-[8px] text-white  px-4 py-2 rounded-2xl shadow-md transition duration-200">
  Get Playlist
</button>
